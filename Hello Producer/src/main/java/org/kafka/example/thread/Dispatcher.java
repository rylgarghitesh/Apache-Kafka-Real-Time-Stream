package org.kafka.example.thread;
...
public class Dispatcher implements Runnable {
    ...
    public void run() {
        ...
        System.out.println("Start Processing " + fileLocation);
        ...
        try (Scanner scanner = new Scanner(file)) {
            ...
            System.out.println("Finished Sending " + counter + " messages from " + fileLocation);
